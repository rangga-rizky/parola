...
{
   protected $n_of_topics,$document_topic_counts,$W,$topic_word_counts,$topic_counts,$document_lengths;

    public function modelling($tokenized_data,$n_of_topics){            
    ...
    private function topic_weight($d, $word, $K_){
        return $this->p_word_given_topic($word, $K_) * $this->p_topic_given_document($K_, $d);
    }
